namespace FromFileToSQLServer
{
    public static class Consts
    {
        public struct Settings
        {
            ...
            public const string ConnectionStringName = "SupplementsPlannerConnectionString";

            public struct Path
            {
                public static readonly string SupplementsRelations = @"D:\websites\SupplementsPlannerWeb\SupplementsPlannerWeb\App_Data\Sources\SupplementsRelationsInformation.xml";
                public static readonly string Supplements = @"D:\websites\SupplementsPlannerWeb\SupplementsPlannerWeb\App_Data\Sources\Supplements.xml";
            }
        }
        ...
        public struct RelationTypes
        {
            ...
            public static readonly string Incompatible = "Incompatible";
        }
